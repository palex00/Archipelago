...
table: dict[str, FlagLocationData] = {
    ...
    "Driftveil City - Item from lady asking for a pokémon knowing a certain TM move": FlagLocationData(0x1BC, always_excluded, "Driftveil City", has_any_tm_hm),
    ...
    "Twist Mountain - Item from worker near ice rock cave": FlagLocationData(0x1BF, always_default, "Twist Mountain", can_beat_ghetsis),
    ...
    "Route 8 - Item from eastern parasol lady": FlagLocationData(0x1C2, always_default, "Route 8", None),
    ...
    "Marvelous Bridge - Patrat shuffle reward": FlagLocationData(0x1C4, always_default, "Marvelous Bridge", can_find_woman_on_village_bridge),
    ...
    "Lacunosa Town - Item from executive": FlagLocationData(0x1CA, always_default, "Lacunosa Town", None),
    # Requires pokémon being randomized
