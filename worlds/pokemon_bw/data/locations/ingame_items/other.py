...
table: dict[str, FlagLocationData | VarLocationData] = {
    ...
    "Striaton Gym - Gym guide item": LocationData(0000000, always_default, "Striaton City", None),
    ...
    "Nacrene City - Item from waitress in Café Warehouse": LocationData(0000000, always_default, "Nacrene City", None),
    ...
    "Nacrene Gym - Gym guide item": LocationData(0000000, always_default, "Nacrene City", None),
    ...
    "Castelia Gym - Gym guide item": LocationData(0000000, always_default, "Castelia City", None),
    ...
    "Nimbasa Gym - Gym guide item": LocationData(0000000, always_default, "Nimbasa City", None),
    ...
    "Driftveil City - Item from lady asking for a pokémon knowing a certain TM move": LocationData(0000000, always_excluded, "Driftveil City", None),
    "Driftveil Gym - Gym guide item": LocationData(0000000, always_default, "Driftveil City", None),
    ...
    "Route 6 - Item from scientist for all Deerling forms": LocationData(0000000, season_dependant, "Route 6", can_catch_all_deerlings),
    ...
    "Icirrus City - Item from the former Team Rocket member's wife": LocationData(0000000, season_dependant, "Icirrus City", can_set_winter),
    "Icirrus Gym - Gym guide item": LocationData(0000000, always_default, "Icirrus City", None),
    ...
    "Route 8 - Item from eastern parasol lady": LocationData(0000000, always_default, "Route 8", None),
    ...
    "Lacunosa Town - Item from executive": LocationData(0000000, always_default, "Lacunosa Town", None),
    "Lacunosa Town - Item from girl for showing a Shaymin": LocationData(0000000, always_default, "Lacunosa Town", has_species("Shaymin")),
    "Route 12 - Item from breeder Ethel #1": LocationData(0000000, always_default, "Route 12", None),
    "Route 12 - Item from breeder Ethel #2": LocationData(0000000, always_default, "Route 12", None),
    "Village Bridge - Item from baker Chris": LocationData(0000000, always_default, "Village Bridge", None),
    # Following 5 items require a random pokémon every day
    "Village Bridge - Item from fisherman for showing a certain pokémon #1": LocationData(0000000, always_excluded, "Village Bridge", None),
    "Village Bridge - Item from fisherman for showing a certain pokémon #2": LocationData(0000000, always_excluded, "Village Bridge", None),
    "Village Bridge - Item from fisherman for showing a certain pokémon #3": LocationData(0000000, always_excluded, "Village Bridge", None),
    "Village Bridge - Item from fisherman for showing a certain pokémon #4": LocationData(0000000, always_excluded, "Village Bridge", None),
    "Village Bridge - Item from fisherman for showing a certain pokémon #5": LocationData(0000000, always_excluded, "Village Bridge", None),
    "Route 11 - Item from ranger Thalia": LocationData(0000000, always_default, "Route 11", None),
    "Route 11 - Item from ranger Crofton": LocationData(0000000, always_default, "Route 11", can_use_waterfall),
    "Opelucid City - Item from female NPC in northern house": LocationData(0000000, always_default, "Opelucid City", None),
    "Opelucid City - Item from linebacker in Drayden's house": LocationData(0000000, always_default, "Opelucid City", None),
    "Opelucid City - Item from female NPC in Drayden's house": LocationData(0000000, always_default, "Opelucid City", None),
    "Opelucid Gym - Gym guide item": LocationData(0000000, always_default, "Opelucid City", None),
    # Don't know how to handle pokémon from other version
    # "Opelucid City - Item from NPC for showing a pokémon knowing Charge from opposite version": LocationData(0000000, always_default, "Opelucid City", None),
    "Opelucid City - Item from Professor Juniper": LocationData(0000000, always_default, "Opelucid City", None),
    "Route 10 - Item from veteran near northern bridge": LocationData(0000000, always_default, "Route 10", None),
    "Route 10 - Item from Bianka #1": LocationData(0000000, always_default, "Route 10", None),
    "Route 10 - Item from Bianka #2": LocationData(0000000, always_default, "Route 10", None),
    "N's Castle - Item from grunt in 3F left room": LocationData(0000000, always_default, "N's Castle", None),
}
