...
gym_badges: dict[str, FlagLocationData | VarLocationData] = {
    ...
    "Opelucid Gym - Badge reward": LocationData(0000000, always_priority, "Opelucid City", None),
}

tm_hm_ncps: dict[str, FlagLocationData | VarLocationData] = {
    "Nuvema Town - TM from Professor Juniper for seeing 25 species": LocationData(0000000, always_default, "Nuvema Town", has_number_of_species(25)),
    "Nuvema Town - TM from Professor Juniper for seeing 60 species": LocationData(0000000, always_default, "Nuvema Town", has_number_of_species(60)),
    "Nuvema Town - TM from Professor Juniper for seeing 115 species": LocationData(0000000, always_default, "Nuvema Town", has_number_of_species(115)),
    ...
    "Opelucid Gym - TM reward": LocationData(0000000, always_default, "Opelucid City", None),
}
